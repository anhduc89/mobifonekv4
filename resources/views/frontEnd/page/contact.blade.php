    ...
    <section class="contact-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="{{ route('contactFormFrontEnd' )}}" method="post" id="contactForm" novalidate="novalidate">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="message" id="message" cols="30"
                                        ...
                                        onblur="this.placeholder = 'Nhập lời nhắn'"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="name" id="name" type="text"
                                        ...
                                        onblur="this.placeholder = 'Nhập họ tên của bạn'" placeholder="Nhập họ tên của bạn">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control valid" name="email" id="email" type="email"
                                        onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Nhập địa chỉ mail'" placeholder="Email">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                ...
                <div class="col-lg-3 offset-lg-1">
                    ...
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3><a href="mailto: {{ $info_companies -> email }}"
                                    class="__cf_email__"

...
@section('content')
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <form action="{{ route('landingpage.addLandingPage') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control ck-form @error('content') is-invalid @enderror" name="content" id="content"
                                            cols="30" rows="15">{{ old('content') }}</textarea>
                                    </div>
                                    @error('content')
                                        <div class="alert alert-warning text-error">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control ck-form" name="advantage" id="advantage" cols="30" rows="10">{{ old('advantage') }}</textarea>
                                    </div>
                                    @error('advantage')
                                        <div class="alert alert-warning text-error">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control ck-form" name="feature" id="feature" cols="30" rows="10">{{ old('feature') }}</textarea>
                                    </div>
                                    @error('feature')
                                        <div class="alert alert-warning text-error">{{ $message }}</div>
                                    @enderror
